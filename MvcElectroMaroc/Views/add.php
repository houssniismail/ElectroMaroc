    ...
    <form action="" method="POST" enctype="multipart/form-data">
      <div class="mt-8 space-y-6">
        ...
        <div>
          ...
          <input type="text" name="prixdAchat"
            class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="text" name="prixdOfer"
            class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
        </div>
        <div>
      ...
      <div class="space-x-4 mt-8">
        ...
        <!-- Secondary -->
        <button
          class="py-2 px-4 bg-white border border-gray-200 text-gray-600 rounded hover:bg-gray-100 active:bg-gray-200 disabled:opacity-50"><a
            href="./dashboard">Cancel</a></button>
      </div>
    </form>
  </div>
</body>
